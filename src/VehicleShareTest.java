...
public class VehicleShareTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Pojazdy Syrena w koszyku klienta f1 kosztowały: " + price(koszykF1, "Syrena", true));
        ...
        System.out.printf("Po zapłaceniu, klientowi f1 zostało: %.2f zł%n",
                f1.getWallet());
